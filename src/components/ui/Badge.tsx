...
type BadgeVariant = "waiting" | "preparing" | "ready" | "serving" | "done" | "neutral"
  ...
  return (
    <span
      className={cn(
        ...
        variant === "serving" && "border-amber-200 bg-amber-50 text-amber-700",
        variant === "ready" && "border-emerald-200 bg-emerald-50 text-emerald-700",
        variant === "done" && "border-emerald-200 bg-emerald-50 text-emerald-700",
